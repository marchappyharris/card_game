# mrh says: This is the output from running python manage.py inspectdb after making modifictions to the database
# (we are not letting django manage the tables).
# The definitions are copied into their appropriate places in the instances and definitions applications' models.
####################################################################################################################
...
class CardDefinition(models.Model):
    front_face_definition = models.ForeignKey('FaceDefinition', models.DO_NOTHING)
    back_face_definition = models.ForeignKey('FaceDefinition', models.DO_NOTHING)
    name = models.CharField(max_length=255)
...
class CollectionDefinitionParentChild(models.Model):
    child_collection_definition = models.ForeignKey(CollectionDefinition, models.DO_NOTHING)
    parent_collection_definition = models.ForeignKey(CollectionDefinition, models.DO_NOTHING)
    name = models.CharField(max_length=255, blank=True, null=True)
