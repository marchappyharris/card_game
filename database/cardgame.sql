...
--
-- Name: playing_cards; Type: VIEW; Schema: cg_schema; Owner: mharris
--

CREATE VIEW playing_cards AS
 SELECT d.id AS deck_id,
   ...
   FROM ((((((((((deck_definition d
     LEFT JOIN deck_definition_m2m_card_definition dc ON ((d.id = dc.deck_definition_id)))
     LEFT JOIN card_definition c ON ((dc.card_definition_id = c.id)))
     LEFT JOIN card_definition_attribute rank_a ON ((c.id = rank_a.card_definition_id)))
     JOIN card_definition_attribute_definition rank_ad ON ((rank_a.card_definition_attribute_definition_id = rank_ad.id)))
     LEFT JOIN card_definition_attribute values_a ON ((c.id = values_a.card_definition_id)))
     JOIN card_definition_attribute_definition values_ad ON ((values_a.card_definition_attribute_definition_id = values_ad.id)))
     LEFT JOIN card_definition_attribute suit_a ON ((c.id = suit_a.card_definition_id)))
     JOIN card_definition_attribute_definition suit_ad ON ((suit_a.card_definition_attribute_definition_id = suit_ad.id)))
     LEFT JOIN face_definition f ON ((c.front_face_definition_id = f.id)))
     LEFT JOIN face_definition b ON ((c.back_face_definition_id = b.id)))
...
ALTER TABLE playing_cards OWNER TO mharris;
...
SELECT pg_catalog.setval('card_definition_attribute_id_seq', 357, true);
...
SELECT pg_catalog.setval('card_definition_id_seq', 119, true);
...
SELECT pg_catalog.setval('collection_definition_id_seq', 13, true);
...
SELECT pg_catalog.setval('collection_definition_parent_child_id_seq', 11, true);
...
SELECT pg_catalog.setval('collection_type_id_seq', 5, true);
...
SELECT pg_catalog.setval('face_definition_id_seq', 180, true);
...
SELECT pg_catalog.setval('game_definition_id_seq', 3, true);
...
--
-- Name: collection_definition_parent_child_parent_collection_definition; Type: INDEX; Schema: cg_schema; Owner: mharris; Tablespace: 
--

CREATE UNIQUE INDEX collection_definition_parent_child_parent_collection_definition ON collection_definition_parent_child USING btree (parent_collection_definition_id, child_collection_definition_id, name);
...
--
-- Name: player_m2m_game_session_player_id_player_alias_game_session_id_; Type: INDEX; Schema: cg_schema; Owner: mharris; Tablespace: 
--

CREATE INDEX player_m2m_game_session_player_id_player_alias_game_session_id_ ON player_m2m_game_session USING btree (player_id, player_alias, game_session_id);
